...
void RenderWidget::paintEvent(QPaintEvent *)
{
 ...
 //    painter.setRenderHint(QPainter::Antialiasing, false);
  ...
  //horizental lines
  myDrawLineB(250, 350, 292, 350);
  myDrawLineB(465, 350, 500, 350);
  myDrawLineB(250, 380, 500, 380);
  ...
  //horizental lines
  myDrawLineB(260, 260, 370, 260);
  myDrawLineB(260, 280, 370, 280);
...
void RenderWidget::myDrawLineB(float x1, float y1, float x2, float y2)
{
  QPainter painter(this);
